...
class OnPolicyCheckActionProcessor :
    ActionProcessor<GetStarted.State, GetStarted.Action.ClickOnPolicyCheck, GetStarted.Effect>() {
    override fun process(
        action: GetStarted.Action.ClickOnPolicyCheck,
        ...
        return flowOf { currentState ->
            ...
            currentState.copy(
                isPolicyCheck = action.isChecked
            )
        }
    }
}
