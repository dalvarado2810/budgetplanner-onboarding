...
class ShowPolicyDialogActionProcessor :
    ActionProcessor<GetStarted.State, GetStarted.Action.ShowPolicyDialog, GetStarted.Effect>() {
    override fun process(
        action: GetStarted.Action.ShowPolicyDialog,
