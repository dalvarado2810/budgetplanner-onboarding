...
class ShowDatePickerActionProcessor :
    ActionProcessor<GetStarted.State, GetStarted.Action.ShowDatePickerDialog, GetStarted.Effect>() {
    override fun process(
        action: GetStarted.Action.ShowDatePickerDialog,
